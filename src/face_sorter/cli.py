...
from face_sorter.services.caching import build_cache
from face_sorter.services.sorting import add_new_class, get_all_class_names, remove_class, sort
...
def train(source_dir, noface_dir, broken_dir, cache_dir):
    """
    ...
    progress = train(source_dir, noface_dir, broken_dir, cache_dir)
...
def build_cache(cache_dir, quality):
    ...
    result = build_cache(cache_dir, quality)
...
def add_class(class_name, cluster_id):
    ...
    add_new_class(class_name, cluster_id)
